...
//     console.log(arr2);
//     console.log(arr2.shift()); //извлекает элемент из начало
//      console.log(arr2);

//     console.log(arr2);
//     console.log(arr2.pop()); //извлекает элемент из конца
//     console.log(arr2);

//    console.log(arr2);
//     arr2.push(10); //добавляет элемент в конец
//     arr2.unshift(9);//добавляет элемент в начало
    
//     console.log(arr2);

//     console.log(arr2[2]);  //результат 3

//     arr2.unshift(15);
//     arr2.unshift(10);
//     console.log(arr2);

//     delete arr2[0]; // удаляет первый элемент и выводит empty item но индекс остается когда вычисляем длину (length)
//     delete arr2[1];
...
//     arr2[50] = 20;
//     console.log(arr2);  // результат [<2 empty items> ,9,2,3,4,10,< 43 empty items>, 20]


    //   for(let i=0; i<arr2.length; i++){  //  первый вариант 
    //   console.log(arr2[i]);
    //   }

    // for (let value of arr2){   //  второй вариант --оба варианта идентичны
    //     console.log(value);
    // }
