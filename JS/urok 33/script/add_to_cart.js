...
let class_name = document.getElementsByClassName("add_cart"); //   получить элементы по имени класса 
console.log(class_name);

let myFunction = function(evt) {
    evt.preventDefault();  // блокировка перехода ссылки (внутри href)

    let title = this.parentNode.parentNode.querySelectorAll(".body_title a");
    let price = this.parentNode.parentNode.querySelectorAll(".price span");
    let image = this.parentNode.parentNode.querySelectorAll(".img img");
